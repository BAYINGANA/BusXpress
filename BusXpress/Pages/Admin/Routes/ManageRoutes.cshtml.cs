...
namespace BusXpress.Pages.Admin.Routes
{
    public class ManageRoutesModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            {
                connection.Open();
                string query = "SELECT RouteId, Origin, Destination, Distance FROM Routes";  // Query for Routes table
                ...
                using (var command = new SqlCommand(query, connection))
                {
                    ...
                    while (reader.Read())
                    {
                        Routes.Add(new Route
                        {
                            ...
                            Distance = reader.GetDecimal(3)  // Changed to GetDecimal
                        });
                    }
                }
            }
    ...
    public class Route
    {
        ...
        public decimal Distance { get; set; }  // Changed to decimal
    }
}
