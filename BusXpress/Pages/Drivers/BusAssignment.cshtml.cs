...
{
    public class BusAssignmentModel : PageModel
    {
        private readonly IConfiguration _configuration;

        // Property to hold the list of assignments (replacing BusAssignments)
        public List<DriverAssignment> DriverAssignments { get; set; }

        // Constructor to inject IConfiguration
        public BusAssignmentModel(IConfiguration configuration)
        {
